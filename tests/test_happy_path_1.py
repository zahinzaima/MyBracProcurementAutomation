...
def test_one(resource):
    ...
    d_page.page.keyboard.press('Enter')
    d_page.wait_to_load_element(d_page.myDashboardItem_procurement)
    d_page.verify_by_title("My Dashboard")
    d_page.get_full_page_screenshot('modular_test_1')
